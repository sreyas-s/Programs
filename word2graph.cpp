...
int main(){
    int n;
    //we have to enter a word.
    //corresponding to that word, we have to construct a graph.
    //civil
    //find out the distinct letters-after that initialize adjacency matrix to all 0s.
    string word;
    cout<<"Enter the word"<<endl;
    cin>>word;
    //we have the word with us.
